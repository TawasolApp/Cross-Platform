  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          key: const ValueKey('choose_premium_plan_back_button'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              key: const ValueKey('choose_premium_plan_text_1'),
              "unlock your 1-month free trial of LinkedIn Premium Career.",
              style: theme.titleLarge,
            ),
            const SizedBox(height: 8),
            Text(
              key: const ValueKey('choose_premium_plan_text_2'),
            ...
            // Billing Cycle
            Text(
              key: const ValueKey('choose_premium_plan_text_3'),
              "Confirm your billing cycle",
              style: theme.titleMedium,
            ),
            const SizedBox(height: 8),
            Text(
              key: const ValueKey('choose_premium_plan_text_4'),
            ...
            // Payment Type
            Text(
              key: const ValueKey('choose_premium_plan_text_5'),
              "Select payment type",
              style: theme.titleMedium,
            ),
            SizedBox(height: pageHeight * 0.012),
            ...
            // Order Summary
            Text(
              key: const ValueKey('choose_premium_plan_text_6'),
              "Order summary",
              style: theme.titleMedium,
            ),
            SizedBox(height: pageHeight * 0.012),
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    key: const ValueKey('choose_premium_plan_text_7'),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                key: const ValueKey('choose_premium_plan_button'),
                onPressed: () async {
                ...
                child: Text(
                  key: const ValueKey('choose_premium_plan_button_text'),
                  "Try now for EGP 0",
                  style: theme.bodyLarge,
                ),
              ),
            ...
            Center(
              child: Text(
                key: const ValueKey('choose_premium_plan_text_8'),
                "Secure checkout",
                style: theme.bodySmall,
              ),
            ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    key: ValueKey('choose_premium_plan_text_9'),
                    title,
                  ...
                  if (subtitle != null) ...[
                    const SizedBox(height: 4),
                    Text(
                      key: ValueKey('choose_premium_plan_text_10'),
                      subtitle,
