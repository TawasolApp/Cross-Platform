...
class CompanyRemoteDataSource {
  ...
  Future<CompanyModel> getCompanyDetails(String companyId) async {
    ...
    final mockJson = {
      ...
      'logoUrl':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2nu6hy93FEDwYnsCt8Ye2wB_5NmEAyrN_Hg&s=10',
      'field': 'Technology',
      'followerCount': 1000,
      'employeeCount': 5000,
    ...
    final mockRelatedCompanies = [
      {
        ...
        'name': 'Innovatech',
        'description':
            'Innovatech is a leading company in innovative technology solutions.',
      ...
      },
      {
        ...
        'description':
            'Future Solutions specializes in futuristic technology and services.',
      ...
      },
      {
        ...
        'name': 'GreenTech',
        'description':
            'GreenTech is a pioneer in sustainable technology solutions.',
      ...
      },
      {
        ...
        'description':
            'NextGen Innovations focuses on next-generation technological advancements.',
