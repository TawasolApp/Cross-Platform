  ...
  static ThemeData lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        elevation: 0,
        disabledBackgroundColor: linkedinLightColorScheme.primary.withValues(
          alpha: 0.5,
        ), //no with opacity with values(alpha channel) does the same thing
      ),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        padding: const EdgeInsets.symmetric(vertical: 14, horizontal: 20),
        elevation: 0,
        disabledBackgroundColor: linkedinDarkColorScheme.primary.withValues(
          alpha: 0.5,
        ),
      ),
    ),
