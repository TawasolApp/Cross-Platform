...
def test_login():
    ...
    time.sleep(5)
    driver.find_element(by="accessibility id", value="Report").click()
    time.sleep(5)
    driver.find_element(by="accessibility id", value="This account is fake").click()
    time.sleep(5)
    driver.find_element(by="accessibility id", value="Report").click()
    time.sleep(3)
    assert driver.find_element(by="accessibility id", value="Failed to submit report").get_attribute("displayed") == 'true'
    time.sleep(5)
