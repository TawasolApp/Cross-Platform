  ...
  group('ProfileProvider Tests', () {
    ...
    group('fetchProfile', () {
      test('should update state with profile data on success', () async {
        ...
        when(mockGetProfileUseCase.call(userId))
      ...
      test('should set error on failure', () async {
        // Arrange
        when(mockGetProfileUseCase.call('test123'))
    ...
    group('Profile Picture', () {
      ...
      //   // Arrange
      //   when(mockUpdateProfilePictureUseCase.call(any))
      ...
      test('deleteProfilePicture should clear profile picture on success',
          () async {
        // Arrange
        profileProvider.profilePicture = 'profile.jpg';
        when(mockDeleteProfilePictureUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Cover Photo', () {
      ...
      //   // Arrange
      //   when(mockUpdateCoverPictureUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteCoverPhoto should clear cover photo on success', () async {
        ...
        when(mockDeleteCoverPhotoUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Headline', () {
      ...
      //   // Arrange
      //   when(mockUpdateHeadlineUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteHeadline should clear headline on success', () async {
        ...
        when(mockDeleteHeadlineUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Industry', () {
      ...
      //   // Arrange
      //   when(mockUpdateIndustryUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteIndustry should clear industry on success', () async {
        ...
        when(mockDeleteIndustryUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Location', () {
      ...
      //   // Arrange
      //   when(mockUpdateLocationUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteLocation should clear location on success', () async {
        ...
        when(mockDeleteLocationUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Name', () {
      ...
      //   // Arrange
      //   when(mockUpdateFirstNameUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      //   // Arrange
      //   when(mockUpdateLastNameUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Resume', () {
      ...
      //   // Arrange
      //   when(mockUpdateResumeUseCase.call(any))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteResume should clear resume on success', () async {
        ...
        when(mockDeleteResumeUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Bio', () {
      ...
      //   // Arrange
      //   when(mockUpdateBioUseCase.call(BioParams(userId: 'test123', bio: bio)))
      //       .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('deleteBio should clear bio on success', () async {
        ...
        when(mockDeleteBioUseCase.call(NoParams()))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Experience', () {
      ...
      test('addExperience should add experience on success', () async {
        // Arrange
        when(mockAddExperienceUseCase.call(testExperience))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('updateExperience should update experience on success', () async {
        ...
        final newExperience = testExperience.copyWith(title: 'Senior Developer');
        profileProvider.experiences = [oldExperience];
        when(mockUpdateExperienceUseCase.call(ExperienceUpdateParams(experienceId: 'exp123', experience: newExperience)))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('removeExperience should remove experience on success', () async {
        ...
        when(mockDeleteExperienceUseCase.call(testExperience.workExperienceId!))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Education', () {
      ...
      test('addEducation should add education on success', () async {
        // Arrange
        when(mockAddEducationUseCase.call(testEducation))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('updateEducation should update education on success', () async {
        ...
        when(mockUpdateEducationUseCase.call(EducationUpdateParams(educationId: 'edu123', education: newEducation)))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('removeEducation should remove education on success', () async {
        ...
        when(mockDeleteEducationUseCase.call(testEducation.educationId!))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Certification', () {
      ...
      test('addCertification should add certification on success', () async {
        // Arrange
        when(mockAddCertificationUseCase.call(testCertification))
            .thenAnswer((_) async => fpdart.Right(null));
        ...
        // Assert
        expect(profileProvider.certifications?.length, 1);
        expect(profileProvider.certifications?[0].name, 'Flutter Certification');
        expect(profileProvider.isLoading, false);
        expect(profileProvider.certificationError, isNull);
      });

      test('updateCertification should update certification on success',
          () async {
        // Arrange
        final oldCertification = testCertification;
        final newCertification =
            testCertification.copyWith(name: 'Advanced Flutter Certification');
        profileProvider.certifications = [oldCertification];
        when(mockUpdateCertificationUseCase.call(CertificationUpdateParams(certificationId: 'cert123', certification: newCertification)))
            .thenAnswer((_) async => fpdart.Right(null));

        // Act
        await profileProvider.updateCertification(oldCertification, newCertification);

        // Assert
        expect(profileProvider.certifications?[0].name,
            'Advanced Flutter Certification');
        expect(profileProvider.isLoading, false);
        expect(profileProvider.certificationError, isNull);
      });

      test('removeCertification should remove certification on success',
          () async {
        // Arrange
        profileProvider.certifications = [testCertification];
        when(mockDeleteCertificationUseCase.call(testCertification.certificationId!))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Skills', () {
      ...
      test('addSkill should add skill on success', () async {
        // Arrange
        when(mockAddSkillUseCase.call(testSkill))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('updateSkill should update skill on success', () async {
        ...
        when(mockUpdateSkillUseCase.call(UpdateSkillParams(skillName: "Flutter", skill: newSkill)))
            .thenAnswer((_) async => fpdart.Right(null));
      ...
      test('removeSkill should remove skill on success', () async {
        ...
        when(mockDeleteSkillUseCase.call(testSkill.skillName))
            .thenAnswer((_) async => fpdart.Right(null));
    ...
    group('Endorsements', () {
      ...
      test('getSkillEndorsements should update state on success', () async {
        // Arrange
        profileProvider.userId = 'test123';
        when(mockGetSkillEndorsementsUseCase.call(GetSkillEndorsementsParams(userId: 'test123', skillName: "Flutter")))
    ...
    group('Expansion Toggles', () {
      ...
      test('toggleExperienceExpansion should toggle experiences expansion state',
          () {
        // Initial state
      ...
      test('toggleEducationExpansion should toggle education expansion state',
          () {
        // Initial state
