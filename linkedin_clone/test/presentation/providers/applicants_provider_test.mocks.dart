...
// in linkedin_clone/test/presentation/providers/applicants_provider_test.dart.
...
class MockGetApplicantsUseCase extends _i1.Mock
    implements _i3.GetApplicantsUseCase {
  ...
  @override
  _i4.Future<List<_i5.ApplicationEntity>> call(
    String? jobId, {
    int? page = 1,
    int? limit = 5,
  }) =>
...
class MockUpdateApplicationStatusUseCase extends _i1.Mock
    implements _i6.UpdateApplicationStatusUseCase {
